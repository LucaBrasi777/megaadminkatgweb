      ...
      <v-card-text>
        <v-card title="" class="bg-primary">
          <v-card-text>
            ...
            <br />
              <br />
              <h4 class="text-center text-white">Тег : Искусство и Литература</h4>
              <br />
              <br />
              <div>
                <VueDatePicker
    ...
    async getData() {
      ...
      try {
        const response = await fetch(
          `https://api-epicnews404.azurewebsites.net/Articles/TopHeadlines?SiteId=1&WithImageOnly=true&CategoryId=3&Language=14&Page=1&PageSize=${pageSize}`
        );
