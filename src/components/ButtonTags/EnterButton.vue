      ...
      <v-card-text>
        <v-card title="" class="bg-primary">
          <v-card-text>
            ...
            <br />
              <br />
              <h4 class="text-center fw-bold text-white">Тег : Кино и ТВ</h4>
              <br />
              <br />
              <div>
                <VueDatePicker
              ...
              <div>
  <h5 class="fw-bold">Исключить из постинга:</h5>
  <div class="" v-for="id in selectedIdsDisplay" :key="id">
    <span class="fw-bold">id новости:{{ id }}</span>
  </div>
</div>
              <v-btn class="mt-2 fw-bold" color="primary" @click="saveData"
                >Просмотр</v-btn
              >
              <v-btn class="mt-2 fw-bold" color="primary" @click="sendPostRequest">Отправить</v-btn>
...
export default {
  ...
  data() {
    return {
      ...
      lastName: "",
      image:
        "https://www.shutterstock.com/image-photo/young-joyful-couple-their-daughter-600nw-2282787215.jpg",
  ...
  methods: {
    ...
    sendTelegramMessage(data) {
      ...
      const tagsMessage = `<b>Теги:</b> Кино и ТВ`;
